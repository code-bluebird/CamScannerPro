...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val folder = File(Environment.getExternalStorageDirectory().toString() + File.separator + "CamScanner-Pro")
        if (!folder.exists()) {
            folder.mkdirs()
        }
    ...
    private fun createImageFile(): File {
        ...
        val storageDir = File(Environment.getExternalStorageDirectory().toString() + File.separator + "CamScanner-Pro/")
