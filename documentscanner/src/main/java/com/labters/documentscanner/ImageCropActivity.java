...
public class ImageCropActivity extends DocumentScanActivity {
    ...
    private String saveToInternalStorage(Bitmap bitmapImage) {
        File file=new File(Environment.getExternalStorageDirectory().toString() + File.separator + "CamScanner-Pro/");
        File directory = file;
        String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.getDefault()).format(new Date());
        String imageFileName = "cropped_" + timeStamp + ".pdf";
        ...
        try {
            ...
            bitmapImage=Bitmap.createScaledBitmap(bitmapImage,bitmapImage.getWidth(),bitmapImage.getHeight(),true);
            paint.setColor(Color.BLUE);
            canvas.drawBitmap(bitmapImage,0,0,null);
            document.finishPage(page);
           /* String targetPdf=mypath+"/test.pdf";
